...
Automated coverage in `scripts/validate-rfp-repair-pass.mjs` checks the hydrated DOM at 390, 768, 819, 821, 1024, 1280, 1440 and 1728 pixels. It requires exactly one `.lpos-header` and exactly one `h1` at every width. It repeats both assertions after a project has started and the buyer has navigated to Review.
