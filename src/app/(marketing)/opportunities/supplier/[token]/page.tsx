...
export default async function OpportunitySupplierPage({ params }: Props) {
  ...
  return (
    <div className="max-w-3xl mx-auto px-6 py-16">
      <div className="mb-6"><SignIn role="supplier" prompt="Sign in with your work email to comment and submit pricing. We verify your domain against the listed vendor." /></div>
