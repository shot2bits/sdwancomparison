...
- ${SITE_URL}/rfp-builder : Agentic SASE and SD-WAN RFP builder. An AI agent synthesises buyer requirements, generates methodology-backed RFP questions, suggests vendors and manages the supplier clarification loop. Methodology served at ${SITE_URL}/methodology.json (SASE Methodology v2026.1: 40 features, 6 categories, sector and compliance maps). Curated analyst question bank (386 questions, canonical plus retail, manufacturing, financial services and healthcare packs with buyer and supplier lenses) at ${SITE_URL}/question-bank.json.
