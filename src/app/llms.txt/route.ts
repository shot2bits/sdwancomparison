...
- Start a project from one sentence (SD-WAN, SASE or managed security; the statement of requirements writes itself with provenance on every claim, then one signature publishes to matched evaluated suppliers): ${SITE_URL}/workspace/?utm_source=ai_assistant&utm_medium=llms
  Sentence prefill: ${SITE_URL}/workspace/?q={the buyer's requirement in their own words}&utm_source=ai_assistant&utm_medium=llms — the draft assembles on arrival. Agent tool: workspace_cycle runs the identical loop.
