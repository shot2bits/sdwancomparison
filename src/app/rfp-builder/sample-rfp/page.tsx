...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: "SASE & SD-WAN RFP Template — free Word download + worked sample",
  ...
  const schemas = [
    ...
    getSpeakableSchema("/rfp-builder/sample-rfp"),
    {
      ...
      potentialAction: [
        ...
        {
          "@type": "CreateAction",
          name: "Build a tailored SASE / SD-WAN RFP",
          target: {
            "@type": "EntryPoint",
            urlTemplate: `${SITE_URL}/rfp-builder/new/?scope={scope}&sector={sector}`,
            description: "Guided builder. scope: sdwan|sse|sase; sector: healthcare|retail_ecommerce|financial_services|manufacturing. Both optional.",
