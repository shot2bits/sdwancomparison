...
export default function RfpSupplierLanding() {
  return (
    <div className="max-w-2xl mx-auto px-6 py-16">
      <p className="eyebrow mb-3">Vendors and service providers</p>
      ...
      <p className="text-[var(--ink-700)] mb-6">
        Don&rsquo;t have a link yet? Sign in to your vendor dashboard to see the opportunities and invitations waiting for you.
      </p>
      <div className="flex flex-wrap gap-3 mb-8">
        <Link href="/supplier" className="rounded-full bg-amber-500 px-5 py-2.5 text-sm font-medium text-zinc-950 no-underline transition-colors hover:bg-amber-400">Go to vendor dashboard</Link>
