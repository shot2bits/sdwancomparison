...
export const metadata: Metadata = {
  ...
  description:
    "Not sure how to approach your SASE, SSE or SD-WAN procurement? Answer three questions and Netify recommends the right route: a quick project notice, a full RFP, or a graded shortlist.",
  alternates: { canonical: `${SITE_URL}/rfp-builder/start/` },
  openGraph: {
    title: "Which procurement route fits your project?",
    description: "Three questions. One recommended route: project notice, full RFP or shortlist.",
  ...
  return (
    <div className="max-w-6xl mx-auto px-6 py-16">
      ...
      <div className="mb-10 max-w-3xl">
        ...
        <h1 id="page-h1" className="mb-4">Not sure whether you need a project notice, an RFP or a shortlist?</h1>
