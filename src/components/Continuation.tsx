  ...
  return (
    ...
    >
      ...
      <textarea
        ...
        rows={3}
        className="mt-3 min-h-[76px] w-full resize-y rounded-[10px] border-[1.5px] border-zinc-300 bg-white px-3.5 py-3 text-[15px] leading-relaxed text-zinc-800 outline-none transition-colors focus:border-slate-500"
      />
