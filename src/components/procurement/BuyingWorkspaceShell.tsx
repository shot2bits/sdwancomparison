...
const CircuitPricing = dynamic(() => import('./CircuitPricing'));
  ...
  return <div className="nf-buying-shell" data-view={view} data-collapsed={collapsed}>
    ...
    <div className="nf-buying-body">
      ...
      <div className="nf-buying-page">
        ...
        <div hidden={view !== 'project'} className="nf-buying-engine"><section className="nf-buying-start" aria-label="Ways to start your project"><nav aria-label="Start your buying journey"><button type="button" onClick={() => { fireNetifyEvent('buying_route_selected', { intent: 'research' }); navigate('compare'); }}>Find suitable providers</button><a href="/sase/pricing/" onClick={() => fireNetifyEvent('buying_route_selected', { intent: 'pricing' })}>Request pricing</a><button type="button" onClick={() => { fireNetifyEvent('buying_route_selected', { intent: 'project' }); projectTool('import'); }}>Bring an RFP or RFI</button></nav></section>{children}</div>
        <section hidden={view !== 'compare'} aria-label="Public provider comparison" className="nf-buying-research"><p className="nf-buying-eyebrow">Public research</p><h2>Compare SASE &amp; SD-WAN providers</h2><p>Explore capability differences. Turn your research into an anonymous project when you are ready.</p>{comparison}</section>
        <section hidden={view !== 'responses'} className="nf-buying-responses"><p className="nf-buying-eyebrow">Supplier responses</p><h2>Bring every response together</h2><p>Open your published project to review supplier submissions, evidence, pricing and clarifications.</p><a className="nf-buying-primary" href="/sase/account/">Open my saved projects →</a><button onClick={() => projectTool('responses')}>View this project’s responses</button><p className="nf-buying-subtle">Still preparing your project? Publish your anonymous brief to invite responses. A full RFP is optional.</p></section>
        <section hidden={view !== 'tools'} className="nf-buying-tools"><p className="nf-buying-eyebrow">Buying tools</p><h2>All tools</h2><p>Every stage of your buying journey, available when you need it.</p><div className="nf-buying-tool-grid">
