...
export default function BuyingFunnelReport(){
 ...
 return <div className="mt-8">
  ...
  {data&&<>
   ...
   <h2 className="mt-7 text-xl font-semibold">Production activity, excluding identified tests</h2>
   <p className="mt-3 text-sm">Identified test events excluded: {data.excluded_test_events}. Historical records without an environment label remain unknown.</p>
