...
export const SAMPLE_NOTICES: SampleNotice[] = [
  ...
  {
    ...BASE,
    slug: "sample-manufacturer-underlay-circuit-pricing",
    is_sample: true,
    id: "sample_mfg_underlay",
    created: now() - 2 * DAY,
    updated: now() - 1 * DAY,
    last_activity: now() - 1 * DAY,
    title: "Indicative pricing for 12 underlay circuits ahead of a formal RFP",
    buyer_org: "",
    buyer_visibility: "anonymous",
    buyer_sector: "manufacturing",
    buyer_size_band: "mid_market",
    scope: ["underlay_circuits", "connectivity"],
    sites: 12,
    regions: ["uk_ireland", "europe"],
    users_band: "500-2500",
    remote_users_band: "under_100",
    ...
    summary:
      "Manufacturer with 9 UK plants and 3 European sites gathering indicative pricing for dedicated internet access circuits (mix of 1Gb and 10Gb) before building a formal RFP. Diverse routing required at two flagship plants.",
    current_environment:
      "Mixed estate of FTTC, leased lines and one legacy MPLS tail. No incumbent preference.",
    desired_outcomes:
      "A realistic budget range per circuit, an understanding of lead times per site, and a view of which carriers can serve all 12 locations.",
    compliance_requirements: [],
    evidence_requested: ["coverage_evidence", "pricing_structure"],
    evaluation_priorities: ["price", "coverage"],
    response_mode: "indicative_pricing",
    response_deadline: now() + 10 * DAY,
    decision_target: null,
    go_live_target: null,
    timeline_note: "Pricing within two weeks; a formal RFP may follow next quarter.",
    ai_summary:
      "A mid-market manufacturer (anonymous) is requesting indicative per-circuit pricing and lead times for 12 dedicated internet access circuits across the UK and Europe, ahead of a possible formal RFP. Suitable respondents include carriers and aggregators with UK and European coverage. Pricing responses are private to the buyer.",
  },
];
