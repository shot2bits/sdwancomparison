...
export const REGULATIONS: Regulation[] = [
  {
    ...
    clauses: [
      "The vendor shall act as processor under a UK GDPR Article 28 compliant data processing agreement, including sub-processor disclosure and approval.",
      "The vendor shall confirm the geographic locations in which personal data is processed and stored, and support UK or EU data residency on request.",
      "The vendor shall notify the buyer of any personal data breach without undue delay and within 72 hours of becoming aware.",
    ],
  ...
  },
  {
    ...
    clauses: [
      "The vendor shall support network segmentation that isolates the cardholder data environment from other networks.",
      "The vendor shall provide an Attestation of Compliance (AOC) or evidence of PCI DSS v4.0 controls relevant to the services supplied.",
    ],
  ...
  },
  {
    ...
    clauses: [
      "The vendor shall support the definition and enforcement of zones and conduits between IT and OT environments.",
      "The vendor shall evidence how the solution prevents lateral movement from enterprise IT into OT networks.",
    ],
  ...
  },
  {
    ...
    clauses: [
      "The vendor shall hold a current ISO/IEC 27001:2022 certificate covering the services supplied, and provide the certificate and statement of applicability scope on request.",
    ],
  ...
  },
  {
    ...
    jurisdiction: "United Kingdom",
    applies_to: "Critical infrastructure and, increasingly, their vendors and service providers.",
    ...
    clauses: [
      "The vendor shall support security incident detection, reporting and response aligned with the buyer's regulatory reporting obligations.",
      "The vendor shall evidence resilience and high-availability design appropriate to critical service continuity.",
    ],
  ...
  },
  {
    ...
    clauses: [
      "The vendor shall include DORA-compliant ICT third-party provisions: defined service levels, audit and access rights, incident reporting, and exit and subcontracting terms.",
      "The vendor shall support threat-led penetration testing and provide the information required for the buyer's Register of Information.",
      "The vendor shall report ICT-related incidents within the timeframes the buyer must meet under DORA.",
    ],
  ...
  },
  {
    ...
    clauses: [
      "The vendor shall support the buyer's NIS2 risk management and incident reporting obligations, including 24-hour early warning and 72-hour notification timeframes.",
      "The vendor shall evidence supply-chain security measures applied to its own operations.",
    ],
