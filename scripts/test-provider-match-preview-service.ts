...
assert.match(session, /getStrictLiveShortlistDataset/);
assert.match(session, /shortlistInputFromProviderMatchInput/);
assert.match(session, /buildShortlist\(scoped, translated\.input, FEATURE_NAMES\)/);
