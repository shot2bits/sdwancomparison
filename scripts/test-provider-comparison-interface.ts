...
assert.match(interfaceSource, /Compare providers or build a shortlist/);
assert.match(interfaceSource, /Compare two providers/);
assert.match(interfaceSource, /Build from requirements/);
assert.match(interfaceSource, /Build a shortlist from your requirements/);
...
assert.match(interfaceSource, /marketplace_url: v\.marketplace_url/);
assert.match(leadRoute, /sase-sd-wan-rfp-builder/);
...
assert.match(interfaceSource, /Live since 1 September 2026/);
assert.match(interfaceSource, /Use the current top five in an RFP/);
assert.doesNotMatch(interfaceSource, /Turn this shortlist into a provider RFP/);
