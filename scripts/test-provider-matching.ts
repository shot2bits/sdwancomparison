...
const base = (overrides: Partial<ProviderMatchRecord>): ProviderMatchRecord => ({ provider_id: "provider:base", slug: "base", display_name: "Base", provider_types: ["technology_vendor"], revision_id: "rev-1", dataset_version: "data-1", capabilities: {}, regions: {}, service_models: {}, sectors: {}, ...overrides });
const providers = [
